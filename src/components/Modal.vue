<template>
    <div class="z-50 fixed w-screen h-screen top-0 left-0 p-4 md:p-8 bg-black bg-opacity-25" style="height: -webkit-fill-available" @click.self="$emit('close')">
...
export default {
    name: 'Modal',
    components: { IconButton, Scrollbar }
}
</script>